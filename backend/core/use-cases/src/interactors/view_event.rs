...
#[derive(::bon::Builder)]
pub struct ViewEventInteractor {
...
#[async_trait]
impl ViewEventBoundary for ViewEventInteractor {
            ...
            .await?
        {
            ...
            ::core::option::Option::Some(AuthTokenPayload { user_role, .. }) =>
                return super::err!(UserUnauthorized {
                    ...
                    allowed_user_roles: ::std::vec![UserRole::EventManager, UserRole::Administrator]
                }),
        }
...
type Request = ViewEventRequest;
type Response = ViewEventResponse;
type OkResponse = ViewEventOkResponse;
type ErrResponse = ViewEventErrResponse;
type UserRole = ViewEventUserRole;
type Event = ViewEventEvent;
