...
#[derive(::bon::Builder)]
pub struct ViewSelfProfileInteractor {
...
#[async_trait]
impl ViewSelfProfileBoundary for ViewSelfProfileInteractor {
...
type Request = ViewSelfProfileRequest;
type Response = ViewSelfProfileResponse;
type OkResponse = ViewSelfProfileOkResponse;
type ErrResponse = ViewSelfProfileErrResponse;
type User = ViewSelfProfileUser;
