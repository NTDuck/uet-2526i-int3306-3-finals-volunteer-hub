...
#[async_trait]
pub trait ViewSelfProfileBoundary {
    async fn apply(
        self: ::std::sync::Arc<Self>, request: ViewSelfProfileRequest,
    ) -> ::axiom::result::Fallible<ViewSelfProfileResponse>;
}
...
pub struct ViewSelfProfileRequest {
...
pub struct ViewSelfProfileOkResponse {
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub user: ViewSelfProfileUser,
}
...
#[cfg_attr(feature = "wasm-bindings", derive(::tsify::Tsify))]
#[cfg_attr(feature = "wasm-bindings", tsify(into_wasm_abi))]
pub struct ViewSelfProfileUser {
    pub id: ::axiom::string::String,

    pub role: ViewSelfProfileUserRole,
    pub statuses: ::std::vec::Vec<ViewSelfProfileUserStatus>,
...
pub enum ViewSelfProfileUserRole {
    Volunteer,
    EventManager,
    Administrator,
}

impl ::core::convert::From<::domain::UserRole> for ViewSelfProfileUserRole {
...
impl ::core::convert::From<ViewSelfProfileUserRole> for ::domain::UserRole {
    fn from(value: ViewSelfProfileUserRole) -> Self {
        match value {
            ViewSelfProfileUserRole::Volunteer => Self::Volunteer,
            ViewSelfProfileUserRole::EventManager => Self::EventManager,
            ViewSelfProfileUserRole::Administrator => Self::Administrator,
        }
    }
}

impl ::core::convert::From<crate::gateways::UserRepositoryViewFilterUserRole> for ViewSelfProfileUserRole {
...
impl ::core::convert::From<ViewSelfProfileUserRole> for crate::gateways::UserRepositoryViewFilterUserRole {
    fn from(value: ViewSelfProfileUserRole) -> Self {
        match value {
            ViewSelfProfileUserRole::Volunteer => Self::Volunteer,
            ViewSelfProfileUserRole::EventManager => Self::EventManager,
...
#[cfg_attr(feature = "wasm-bindings", derive(::tsify::Tsify))]
#[cfg_attr(feature = "wasm-bindings", tsify(from_wasm_abi, into_wasm_abi))]
pub enum ViewSelfProfileUserStatus {
    Created {
...
#[::bon::bon]
impl ViewSelfProfileUserStatus {
    ...
    pub async fn build_from(
        ...
        match status {
            ::domain::UserStatus::Created { created_at } => ViewSelfProfileUserStatus::Created {
                created_at: ::std::sync::Arc::clone(&timestamp_codec).format(created_at).await?,
            }
            .into_ok(),
            ::domain::UserStatus::Updated { updated_at } => ViewSelfProfileUserStatus::Updated {
...
#[cfg_attr(feature = "wasm-bindings", derive(::tsify::Tsify))]
#[cfg_attr(feature = "wasm-bindings", tsify(into_wasm_abi))]
pub enum ViewSelfProfileErrResponse {
    ...
    UserUnauthorized {
        user_role: ViewSelfProfileUserRole,
        allowed_user_roles: ::std::vec::Vec<ViewSelfProfileUserRole>,
    },
}
