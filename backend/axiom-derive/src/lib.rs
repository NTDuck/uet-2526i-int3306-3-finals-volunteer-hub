...
/// 
/// Assumes: **(1)** the target is a no-generic enum; **(2)** `serde` and `thiserror` are within scope.
...
/// Generates the following: **(1)** `#vis fn new(value: ::axiom::aliases::string::String) -> ::core::result::Result<Self, #error_ident>`; **(2)** `#vis const fn hint() -> ::axiom::aliases::string::String`; **(3)** `impl ::core::ops::Deref for #ident`; **(4)** `impl ::core::convert::Into<::axiom::aliases::string::String> for #ident`; **(5)** `impl ::core::convert::TryFrom<::axiom::aliases::string::String> for #ident`; **(6)** `#error_ident`, defaulted to `#ident BuilderError`; **(7)** `impl ::core::convert::Into<::axiom::aliases::string::String> for #error_ident`;
/// 
/// Assumes: **(1)** the target is a newtype of `::axiom::aliases::string::String`; **(2)** `bon` and `thiserror` are within scope.
